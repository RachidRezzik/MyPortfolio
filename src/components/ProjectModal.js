...
export default function ProjectModal(props) {
    ...
    if (project.title == "ECLIPSE"){
        project_description_links = <div>
            <p>
                Fitness company offering activewear for men and women. User can search for products, find related products to the one they're already previewing, add products to their bag, edit their bag, and apply coupon codes to their total. 
            </p>
